            ...
            <div>
                <form action="#" method="get" className={ styles.main }>
                    ...
                    <div className={ styles.rigth_content }>
                        ...
                        <p className={ styles.name_input }>Имя</p> <input className={ styles.input } type="text"
                                                                          required
                                                                          placeholder="   Введите Ваше имя"/><br/>
                        <p className={ styles.name_input }>Email</p> <input className={ styles.input } type="email"
                                                                            required placeholder="    example@mail.ru"/><br/>
                        <p className={ styles.name_input }>Сообщение</p> <br/>
                        <textarea className={ styles.input } required id="Message" cols="50" rows="30"
                                  placeholder="    Введите текст сообщения"></textarea> <br/>
