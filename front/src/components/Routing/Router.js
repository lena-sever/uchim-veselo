...
function Router() {
    ...
    const path3 = pathname == `/courses/${ courseId }/slider3`;
    const path4 = pathname == `/courses/${ courseId }/tests`;

    return (
        <>
            {
                path1 || path2 || path3 || path4 ? null : <Header/>
            }
            <div className={ path1 || path2 || path3 || path4 ? "main" : "main main-header" }>
                <Routes>
            ...
            {
                path1 || path2 || path3 || path4 ? null : <Footer/>
            }
        </>
    );
}
