    ...
    <>
      <footer class="footer">
            <div class="footer-wrp">
                <span class="footer-text-polity">&copy; Copyright Учим Весело 2022, All rights reserved.</span>
                <div class="footer__social-icon-wrp">
                    <a href="#" class="footer__social-icon-link">
                        <svg class="footer__social-icon" width="22" height="22" id="Bold"
                    ...
                    <a href="#" class="footer__social-icon-link">
                        <svg class="footer__social-icon" width="22" height="22" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 448 512">
                            <path
